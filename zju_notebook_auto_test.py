...
def send_DinTalk(log_contents):
    ...
    json_text = {
        ...
        "text": {
            "content": "浙大环境的项目创建异常，请检查网站.详情查收邮件"+format(log_contents)
        }
    }
...
class NotebookTest(unittest.TestCase):
    ...
    def test_notebook(self):
        ...
        logger.warning("登录")
        time.sleep(3)
        # driver.find_element_by_css_selector('#mo-header > div > ul:nth-child(1) > li:nth-child(2) > a').click()
        ...
        notebook_panel = '#jp-main-dock-panel > .p-Widget.jp-MainAreaWidget.jp-NotebookPanel.jp-Document.jp-Activity.p-DockPanel-widget:not(.p-mod-hidden)'

        logger.warning('点击新建的cell')
        time.sleep(3)


        code_selector = f"{notebook_panel} div > " \
        f"div.p-Widget.p-Panel.jp-Cell-inputWrapper > " \
        f"div.p-Widget.jp-InputArea.jp-Cell-inputArea > div.p-Widget.p-Panel.code-bar-parent > div.p-Widget.jp-CodeMirrorEditor.jp-Editor.jp-InputArea-editor > div > div.CodeMirror-scroll > div.CodeMirror-sizer > div > div > div > div.CodeMirror-code > pre"

        try:
            driver.find_element_by_css_selector(code_selector).click()
        except Exception:
            driver.find_element_by_css_selector(code_selector).click()
        ...
        time.sleep(3)
        driver.find_element_by_css_selector(
            f"{notebook_panel} div > "
            f"div.p-Widget.p-Panel.jp-Cell-inputWrapper > "
            "div.p-Widget.jp-InputArea.jp-Cell-inputArea > div.p-Widget.p-Panel.code-bar-parent > div.p-Widget.jp-CodeMirrorEditor.jp-Editor.jp-InputArea-editor > div > div > textarea").send_keys(
            "print('hello test')\nprint('hello world')")

        logger.warning('运行 cell')
        time.sleep(3)
        driver.find_element_by_css_selector(
            f"{notebook_panel} div > div.p-Widget.p-Panel.jp-Cell-inputWrapper > div.p-Widget.jp-InputArea.jp-Cell-inputArea > div.p-Widget.p-Panel.code-bar-parent > div.p-Widget.jp-CodeMirrorEditor.jp-Editor.jp-InputArea-editor > div > div > textarea").send_keys(
        ...
        time.sleep(3)
        driver.find_element_by_css_selector(
            f"{notebook_panel} div.p-Widget.jp-Cell.slideCell.jp-CodeCell.jp-mod-noOutputs.jp-Notebook-cell.jp-mod-active.jp-mod-selected.jp-mod-collapsed > div.p-Widget.p-Panel.jp-Cell-inputWrapper > div.p-Widget.jp-InputArea.jp-Cell-inputArea > div.p-Widget.p-Panel.code-bar-parent > div.p-Widget.jp-CodeMirrorEditor.jp-Editor.jp-InputArea-editor > div > div.CodeMirror-scroll > div.CodeMirror-sizer > div > div > div > div.CodeMirror-code > pre").click()
        ...
        assert driver.find_element_by_css_selector(
            f"{notebook_panel} div:nth-child(2) > div.p-Widget.p-Panel.jp-Cell-outputWrapper > div.p-Widget.jp-OutputArea.jp-Cell-outputArea > div > div.p-Widget.jp-RenderedText.jp-mod-trusted.jp-OutputArea-output > pre").text == '4950'
        driver.close()
...
def send_email(log_contents):
    ...
    if check_url == 'https://mo.zju.edu.cn' and not debugMode:
        ...
        subject = '浙大' + ' 项目创建异常，请检查网站'
        # print('线上已发送')
    else:
        emails = '498593970@qq.com'
        subject = '浙大测试' + '测试环境的项目创建异常，请检查网站'
...
def run_all_test():
    ...
    #     shell=True)
    result = requests.delete('https://mo.zju.edu.cn/pyapi/user/notebook_autotest_project?username=luxu99&token=a2c4bebb78d5569572dc486c761f1723')
    print(result.text)
    # 只在 prod 和 rc 上开启测试
